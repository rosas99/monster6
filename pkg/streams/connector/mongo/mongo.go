...
func (ms *MongoSink) capCollection() (ok bool) {
	...
	exists, err := ms.collectimonsterists(colName)
	if err != nil {
...
// collectimonsterists checks to see if a collection name exists in the db.
func (ms *MongoSink) collectimonsterists(name string) (bool, error) {
