...
const (
	// UserAgent is the userAgent name when starting monster-pump server.
...
// ApplyTo fills up monster-pump config with options.
...
// Config return an monster-pump config object.
