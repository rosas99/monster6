...
const (
	// UserAgent is the userAgent name when starting monster-nightwatch server.
...
// ApplyTo fills up monster-fakeserver config with options.
...
// Config return a monster-fakeserver config object.
